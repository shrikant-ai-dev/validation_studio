...
def render_validation_generator():
    ...
    with help_tab:
        ...
        with st.expander("Step 1: Choose How to Provide Rules", expanded=True):
            st.markdown("""
        ...
        with st.expander("Step 2: Review and Edit Rules", expanded=True):
            st.markdown("""
        ...
        with st.expander("Step 3: Generate and Download", expanded=True):
            st.markdown("""
        ...
        with st.expander("Step 4: Review the Results", expanded=True):
            st.markdown("""
...
def render_notebook_reviewer():
    ...
    st.markdown("""
        Upload a Databricks notebook (`.py` file) to review it against development best practices.
        """)
